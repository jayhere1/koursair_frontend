    ...
    <div className="bg-white">
      ...
      <div className="bg-[#F4EFE7] text-gray-600 px-6 md:px-20 py-10 max-w-6xl mx-auto">
        ...
        <Section title="General Terms">
          <p className="mb-4">
            By accessing and placing an order with Koursair, you confirm that you are in agreement with and bound by
            the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire
            website and any email or other type of communication between you and Koursair.
          </p>
          <p className="mb-4">
            Under no circumstances shall Koursair team be liable for any direct, indirect, special, incidental or
            consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the
            inability to use, the materials on this site, even if Koursair team or an authorized representative has been
          ...
          <p>
            Koursair will not be responsible for any outcome that may occur during the course of usage of our resources.
        ...
        <Section title="License">
          <p className="mb-4">
            Koursair grants you a revocable, non-exclusive, non-transferable, limited license to download, install and use
            the website strictly in accordance with the terms of this Agreement.
          </p>
          <p className="mb-4">
            These Terms & Conditions are a contract between you and Koursair (referred to in these Terms & Conditions
            as &quot;Koursair&quot;, &quot;us&quot;, &quot;we&quot; or &quot;our&quot;), the provider of the Koursair website and the services accessible from the
            Koursair website (which are collectively referred to in these Terms & Conditions as the &quot;Koursair Service&quot;).
          </p>
          <p>
            You are agreeing to be bound by these Terms & Conditions. If you do not agree to these Terms &
            Conditions, please do not use the Koursair Service. In these Terms & Conditions, &quot;you&quot; refers both to you as
        ...
        <Section title="Definitions and key terms">
          ...
          <ul className="list-disc pl-5 space-y-3">
            <li>
              <strong>Cookie:</strong> small amount of data generated by a website and saved by your web browser. It is used to
              identify your browser, provide analytics, remember information about you such as your language
              preference or login information.
            </li>
            <li>
              <strong>Company:</strong> when this terms mention “Company,” “we,” “us,” or “our,” it refers to Koursair Inc, (800 The
              Mark Lane ), that is responsible for your information under this Terms & Conditions.
            </li>
            <li>
              <strong>Country:</strong> where Koursair or the owners/founders of Koursair are based, in this case is United States.
            </li>
            <li>
              <strong>Device:</strong> any internet connected device such as a phone, tablet, computer or any other device that can
              be used to visit Koursair and use the services.
            </li>
            <li>
              <strong>Service:</strong> refers to the service provided by Koursair as described in the relative terms (if available) and
              on this platform.
            </li>
            <li>
              <strong>Third-party service:</strong> refers to advertisers, contest sponsors, promotional and marketing partners, and
              others who provide our content or whose products or services we think may interest you.
            </li>
            <li>
              <strong>Website:</strong> Koursair’s site, which can be accessed via this URL: https://koursair.com/
            </li>
            <li>
              <strong>You:</strong> a person or entity that is registered with Koursair to use the Services.
            </li>
          </ul>
          <p className="mt-4 italic text-sm">This Terms & Conditions were created with Termify.</p>
        </Section>
        ...
        <Section title="Restrictions">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              ...
              Koursair or its affiliates, partners, suppliers or the licensors of the website.
            </li>
          </ul>
        </Section>
        ...
        <Section title="Payment">
          <p className="mb-4">
            ...
            charge is due and payable. Unless otherwise indicated in an order form, you must provide Koursair with a
            ...
            liabilities with respect to your Payment Provider. By providing Koursair with your credit card number and
            associated payment information, you agree that Koursair is authorized to verify information immediately, and
            subsequently invoice your account for all fees and charges due and payable to Koursair hereunder and that
            no additional notice or consent is required. You agree to immediately notify Koursair of any change in your
            billing address or the credit card used for payment hereunder. Koursair reserves the right at any time to
          ...
          <p className="mb-4">
            No contract will exist between you and Koursair for the Service until Koursair accepts your order by a
        ...
        <Section title="Return and Refund Policy">
          <p className="mb-4">
            Thanks for shopping at Koursair. We appreciate the fact that you like to buy the stuff we build. We also want
            to make sure you have a rewarding experience while you’re exploring, evaluating, and purchasing our
            products.
          </p>
          <p className="mb-4">
            As with any shopping experience, there are terms and conditions that apply to transactions at Koursair. We’ll
            be as brief as our attorneys will allow. The main thing to remember is that by placing an order or making a
            purchase at Koursair, you agree to the terms along with Koursair’s Privacy Policy.
          </p>
          <p>
        ...
        <Section title="Your Suggestions">
          <p className="mb-4">
            ...
            to Koursair with respect to the website shall remain the sole and exclusive property of Koursair.
          </p>
          <p>
            Koursair shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose and in
        ...
        <Section title="Links to Other Websites">
          <p>
            ...
            operated or controlled by Koursair. We are not responsible for the content, accuracy or opinions expressed
        ...
        <Section title="Cookies">
          <p>
            Koursair uses &quot;Cookies&quot; to identify the areas of our website that you have visited. A Cookie is a small piece
        ...
        <Section title="Changes To Our Terms & Conditions">
          <p className="mb-4">
            You acknowledge and agree that Koursair may stop (permanently or temporarily) providing the Service (or
            any features within the Service) to you or to users generally at Koursair’s sole discretion, without prior notice
            to you. You may stop using the Service at any time. You do not need to specifically inform Koursair when
            you stop using the Service. You acknowledge and agree that if Koursair disables access to your account,
            you may be prevented from accessing the Service, your account details or any files or other materials which
        ...
        <Section title="Modifications to Our website">
          <p>
            Koursair reserves the right to modify, suspend or discontinue, temporarily or permanently, the website or any
            service to which it connects, with or without notice and without liability to you.
          </p>
        </Section>

        <Section title="Updates to Our website">
          <p className="mb-4">
            Koursair may from time to time provide enhancements or improvements to the features/ functionality of the
            website, which may include patches, bug fixes, updates, upgrades and other modifications (&quot;Updates&quot;).
            Updates may modify or delete certain features and/or functionalities of the website. You agree that Koursair
        ...
        <Section title="Third-Party Services">
          ...
          <p className="mb-4">
            You acknowledge and agree that Koursair shall not be responsible for any Third-Party Services, including
            their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any
            other aspect thereof. Koursair does not assume and shall not have any liability or responsibility to you or any
        ...
        <Section title="Term and Termination">
          <p className="mb-4">
            This Agreement shall remain in effect until terminated by you or Koursair.
          </p>
          <p className="mb-4">
            Koursair may, in its sole discretion, at any time and for any or no reason, suspend or terminate this
            Agreement with or without prior notice.
          </p>
          <p className="mb-4">
            This Agreement will terminate immediately, without prior notice from Koursair, in the event that you fail to
          ...
          <p>
            Termination of this Agreement will not limit any of Koursair&apos;s rights or remedies at law or in equity in case of
        ...
        <Section title="Indemnification">
          <p>
            You agree to indemnify and hold Koursair and its parents, subsidiaries, affiliates, officers, employees,
        ...
        <Section title="No Warranties">
          <p className="mb-4">
            ...
            of any kind. To the maximum extent permitted under applicable law, Koursair, on its own behalf and on
            ...
            foregoing, Koursair provides no warranty or undertaking, and makes no representation of any kind that the
          ...
          <p className="mb-4">
            Without limiting the foregoing, neither Koursair nor any Koursair&apos;s provider makes any representation or
            ...
            website; or (iv) that the website, its servers, the content, or e-mails sent from or on behalf of Koursair are free
        ...
        <Section title="Limitation of Liability">
          <p className="mb-4">
            Notwithstanding any damages that you might incur, the entire liability of Koursair and any of its suppliers
          ...
          <p className="mb-4">
            To the maximum extent permitted by applicable law, in no event shall Koursair or its suppliers be liable for
            ...
            this Agreement), even if Koursair or any supplier has been advised of the possibility of such damages and
        ...
        <Section title="Severability">
          ...
          <p>
            This Agreement, together with the Privacy Policy and any other legal notices published by Koursair on the
            Services, shall constitute the entire agreement between you and Koursair concerning the Services. If any
            ...
            such term or any other term, and Koursair’s failure to assert any right or provision under this Agreement shall
            not constitute a waiver of such right or provision. YOU AND Koursair AGREE THAT ANY CAUSE OF
        ...
        <Section title="Amendments to this Agreement">
          <p className="mb-4">
            Koursair reserves the right, at its sole discretion, to modify or replace this Agreement at any time. If a
          ...
          <p>
            ...
            the revised terms. If you do not agree to the new terms, you are no longer authorized to use Koursair.
          </p>
        </Section>

        <Section title="Entire Agreement">
          <p className="mb-4">
            The Agreement constitutes the entire agreement between you and Koursair regarding your use of the
            website and supersedes all prior and contemporaneous written or oral agreements between you and
            Koursair.
          </p>
          <p>
            You may be subject to additional terms and conditions that apply when you use or purchase other Koursair&apos;s
            services, which Koursair will provide to you at the time of such use or purchase.
          </p>
        </Section>

        <Section title="Updates to Our Terms">
          <p className="mb-4">
        ...
        <Section title="Intellectual Property">
          <p>
            ...
            owned by Koursair, its licensors or other providers of such material and are protected by United States and
            ...
            or in part, without the express prior written permission of Koursair, unless and except as is expressly
            provided in these Terms & Conditions. Any unauthorized use of the material is prohibited.
          </p>
        </Section>

        <Section title="Agreement to Arbitrate">
          <p>
            This section applies to any dispute EXCEPT IT DOESN’T INCLUDE A DISPUTE RELATING TO CLAIMS
            FOR INJUNCTIVE OR EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR
            OR Koursair’s INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute, action, or
            other controversy between you and Koursair concerning the Services or this agreement, whether in contract,
        ...
        <Section title="Notice of Dispute">
          <p>
            In the event of a dispute, you or Koursair must give the other a Notice of Dispute, which is a written
            ...
            info@koursair.com. Koursair will send any Notice of Dispute to you by mail to your address if we have it, or
            otherwise to your email address. You and Koursair will attempt to resolve any dispute through informal
            negotiation within sixty (60) days from the date the Notice of Dispute is sent. After sixty (60) days, you or
            Koursair may commence arbitration.
          </p>
        </Section>

        <Section title="Binding Arbitration">
          <p>
            If you and Koursair don’t resolve any dispute by informal negotiation, any other effort to resolve the dispute
        ...
        <Section title="Submissions and Privacy">
          <p>
            ...
            non-confidential and non-proprietary and will become the sole property of Koursair without any compensation
            or credit to you whatsoever. Koursair and its affiliates shall have no obligations with respect to such
        ...
        <Section title="Promotions">
          <p className="mb-4">
            Koursair may, from time to time, include contests, promotions, sweepstakes, or other activities
        ...
        <Section title="Typographical Errors">
          <p>
        ...
        <Section title="Miscellaneous">
          <p className="mb-4">
            ...
            authorized representative of Koursair. Koursair will be entitled to injunctive or other equitable relief (without
            the obligations of posting any bond or surety) in the event of any breach or anticipatory breach by you.
          </p>
          <p>
            Koursair operates and controls the Koursair Service from its offices in United States. The Service is not
            intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution
            or use would be contrary to law or regulation. Accordingly, those persons who choose to access the Koursair
            Service from other locations do so on their own initiative and are solely responsible for compliance with local
            laws, if and to the extent local laws are applicable. These Terms & Conditions (which include and incorporate
            the Koursair Privacy Policy) contains the entire understanding, and supersedes all prior understandings,
            between you and Koursair concerning its subject matter, and cannot be changed or modified by you. The
        ...
        <Section title="Disclaimer">
          <p className="mb-4">
            Koursair is not responsible for any content, code or any other imprecision.
          </p>
          <p className="mb-4">
            Koursair does not provide warranties or guarantees.
          </p>
          <p className="mb-4">
            In no event shall Koursair be liable for any special, direct, indirect, consequential, or incidental damages or
          ...
          <p>
            The Koursair Service and its contents are provided &quot;as is&quot; and &quot;as available&quot; without any warranty or
            representations of any kind, whether express or implied. Koursair is a distributor and not a publisher of the
            content supplied by third parties; as such, Koursair exercises no editorial control over such content and
            makes no warranty or representation as to the accuracy, reliability or currency of any information, content,
            service or merchandise provided through or accessible via the Koursair Service. Without limiting the
            foregoing, Koursair specifically disclaims all warranties and representations in any content transmitted on or
            in connection with the Koursair Service or on sites that may appear as links on the Koursair Service, or in the
            products provided as a part of, or otherwise in connection with, the Koursair Service, including without
            limitation any warranties of merchantability, fitness for a particular purpose or non-infringement of third party
            rights. No oral advice or written information given by Koursair or any of its affiliates, employees, officers,
            directors, agents, or the like will create a warranty. Price and availability information is subject to change
            without notice. Without limiting the foregoing, Koursair does not warrant that the Koursair Service will be
        ...
        <Section title="Contact Us">
          ...
          <ul className="list-disc pl-5">
            <li>Via Email: info@koursair.com</li>
          </ul>
        </Section>
      </div>
      <FooterSection />
