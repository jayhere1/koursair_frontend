      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 ">
          ...
          {activities.slice(0, 3).map((activity, index) => (
            <div
              key={activity.id}
              className={`relative group cursor-pointer overflow-hidden shadow-lg hover:shadow-2xl rounded-xl transition-all duration-500 transform hover:scale-105 ${
          ...
          <div className="md:col-span-2">
            <div
              className="relative group cursor-pointer overflow-hidden shadow-lg hover:shadow-2xl rounded-xl transition-all duration-500 transform hover:scale-105 h-[300px] sm:h-[330px] md:h-[370px]"
